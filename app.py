...
HF_MODEL_URL = "https://api-inference.huggingface.co/models/mistralai/Mistral-7B-Instruct-v0.2"  # Puedes cambiar el modelo aquí (por ejemplo, mistralai/Mistral-7B-Instruct-v0.2)
